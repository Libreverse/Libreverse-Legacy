...
Gem::Specification.new do |spec|
  ...
  spec.summary       = "Rails/Rack middleware to enable delivery of non-digest assets"
  spec.description   = "Rails/Rack middleware to enable delivery of non-digest assets with appropriate cache headers."
